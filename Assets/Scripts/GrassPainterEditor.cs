...
public class GrassPainterEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        grassPainter.sizeWidth = EditorGUILayout.Slider("Grass Width", grassPainter.sizeWidth, 0f, 5f);
        grassPainter.sizeLength = EditorGUILayout.Slider("Grass Length", grassPainter.sizeLength, 0f, 5f);
        EditorGUILayout.Space();
